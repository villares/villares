...
def draw():
    ...
    noFill()
    strokeWeight(1)
    # poly_rounded2(p_list, rad_list, arc_func=arc)
    # poly_rounded2(p_list, rad_list, arc_func=p_arc)
    poly_rounded2(p_list, rad_list, arc_func=b_arc)
    strokeWeight(2)
    arc_augmented_poly(p_list, rad_list)
...
#         a = circ_circ_tangent3(p1, p2, r1, r2)
#         a_list.append(a)
...
# def circ_circ_tangent3(p1, p2, r1, r2):
